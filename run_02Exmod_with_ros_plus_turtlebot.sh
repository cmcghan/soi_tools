...
# modified from: http://learn.turtlebot.com/2015/02/03/7/
gnome-terminal -e 'bash -c "cd catkin_lmcp; source devel/setup.bash; roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=/opt/ros/kinetic/share/turtlebot_gazebo/worlds/empty.world; read line"'

# modified from: http://learn.turtlebot.com/2015/02/03/7/
#gnome-terminal -e 'bash -c "cd catkin_lmcp; source devel/setup.bash; roslaunch turtlebot_gazebo amcl_demo.launch; read line"'

# modified from: http://learn.turtlebot.com/2015/02/03/7/
#gnome-terminal -e 'bash -c "cd catkin_lmcp; source devel/setup.bash; rosrun tf tf_echo /map /base_link; read line"'
